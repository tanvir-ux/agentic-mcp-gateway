...
A recruiter-runnable demo of how a senior engineer wires **Model Context Protocol (MCP)** tools into an **agentic loop** for operations work: retrieve policy from a local knowledge base (RAG), search mock payments, and open tickets — the same shape as production copilots that sit in front of core banking / ops APIs, without any proprietary code.
